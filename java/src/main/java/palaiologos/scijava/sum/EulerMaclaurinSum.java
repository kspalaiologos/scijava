...
public class EulerMaclaurinSum {
    public static Pair<SciFloat, SciFloat> sum(MathContext mc, RealFunction f, SciFloat a, SciFloat b, Stream<SciFloat> aDiffs, Stream<SciFloat> bDiffs) {
        final int M = 10000;
        ...
        if(a.isInf() && a.lt(SciFloat.ZERO)) {
            ...
            ad = Stream.generate(new Supplier<>() {
                private int d = 0;
        ...
        if(b.isInf() && b.lt(SciFloat.ZERO)) {
            ...
            bd = Stream.generate(new Supplier<>() {
                private int d = 0;
